...
uint8_t VL53L5CX_RdByte(const VL53L5CX_Platform *p_platform, uint16_t RegisterAddress, uint8_t *p_value);
...
uint8_t VL53L5CX_WrByte(const VL53L5CX_Platform *p_platform, uint16_t RegisterAddress, uint8_t value);
...
uint8_t VL53L5CX_RdMulti(const VL53L5CX_Platform *p_platform, uint16_t RegisterAddress, uint8_t *p_values,
                         uint32_t size);
...
uint8_t VL53L5CX_WrMulti(const VL53L5CX_Platform *p_platform, uint16_t RegisterAddress, const uint8_t *p_values,
                         uint32_t size);
